                ...
                <div class="table-wrapper">
                    ...
                    <div class="d-flex align-items-baseline  justify-content-between">
                        <form class="col-sm-6 input-group mb-3 mt-5" method="POST" style="max-width:500px;">
                                     ...
                                     <input type="text" name="search"  class="form-control" id="myinput" placeholder="rechercher..." aria-label="Recipient's username" aria-describedby="button-addon2">
                          ...
                          <a href="#addetud" class="btn btn-order  btn-lg fs-3 mb-1 rounded-3 merriweather" data-bs-toggle="modal" data-bs-target="#exampleModal" > + </a>
                   </div>
